 ...
 * Added Admin password reset for staff members.
 */
...
export default function UserManagement() {
  ...
  async function handleResetPassword(e) {
    ...
    try {
      await resetStaffPassword(resetMember.staff_id, resetForm.password);
      toast.success(`Password reset successfully for ${resetMember.full_name}.`);
      closeResetPassword();
    } catch (err) {
                    ...
                    <div className="flex flex-wrap gap-2">
                      {editId === member.staff_id ? (
                        <>
                          <button
                            type="button"
                            onClick={() => handleSaveEdit(member.staff_id)}
                            disabled={isEditing}
