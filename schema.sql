...
CREATE TABLE COMPLAINTS (
  ...
  department_id       INT           NOT NULL,  -- FK → DEPARTMENTS, mandatory
  type_id             INT           NOT NULL,  -- FK → COMPLAINT_TYPES, mandatory
  title               VARCHAR(200)  NOT NULL,
  description         TEXT          NOT NULL,
  category            VARCHAR(100)  NOT NULL,
  priority            ENUM('Low','Medium','High','Urgent') NOT NULL DEFAULT 'Medium',
  file_number         VARCHAR(50)   NOT NULL,  -- auto-generated unique complaint file/reference number
  ...
  UNIQUE KEY uq_complaints_file_number (file_number),
  ...
  INDEX idx_complaint_file_no   (file_number),
